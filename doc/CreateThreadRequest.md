# openai_flutter_sdk.model.CreateThreadRequest
...
------------ | ------------- | ------------- | -------------
**messages** | [**List<CreateMessageRequest>**](CreateMessageRequest.md) | A list of [messages](/docs/api-reference/messages) to start the thread with. | [optional] [default to const []]
