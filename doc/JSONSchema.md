# openai_flutter_sdk.model.JSONSchema
...
**schema** | [**BuiltMap&lt;String, JsonObject&gt;**](JsonObject.md) | The schema for the response format, described as a JSON Schema object. Learn how to build JSON schemas [here](https://json-schema.org/).  | [optional] 
