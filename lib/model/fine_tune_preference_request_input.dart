...
class FineTunePreferenceRequestInput {
  ...
  FineTunePreferenceRequestInput({
    this.input,
    this.preferredOutput = const [],
    this.nonPreferredOutput = const [],
  });
  ...
  bool operator ==(Object other) => identical(this, other) || other is FineTunePreferenceRequestInput &&
    other.input == input &&
    _deepEquality.equals(other.preferredOutput, preferredOutput) &&
    _deepEquality.equals(other.nonPreferredOutput, nonPreferredOutput);

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (input == null ? 0 : input!.hashCode) +
    (preferredOutput.hashCode) +
    (nonPreferredOutput.hashCode);

  @override
  String toString() => 'FineTunePreferenceRequestInput[input=$input, preferredOutput=$preferredOutput, nonPreferredOutput=$nonPreferredOutput]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.input != null) {
      ...
      json[r'preferred_output'] = this.preferredOutput;
      json[r'non_preferred_output'] = this.nonPreferredOutput;
    return json;
  }
  ...
  static FineTunePreferenceRequestInput? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return FineTunePreferenceRequestInput(
        ...
        preferredOutput: ChatCompletionRequestAssistantMessage.listFromJson(json[r'preferred_output']),
        nonPreferredOutput: ChatCompletionRequestAssistantMessage.listFromJson(json[r'non_preferred_output']),
      );
    }
    return null;
  }
