...
class FineTuningJobHyperparameters {
  ...
  ///
  FineTuningJobHyperparametersBatchSize? batchSize;
  ...
  @override
  String toString() => 'FineTuningJobHyperparameters[batchSize=$batchSize, learningRateMultiplier=$learningRateMultiplier, nEpochs=$nEpochs]';
  ...
  static FineTuningJobHyperparameters? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return FineTuningJobHyperparameters(
        batchSize: FineTuningJobHyperparametersBatchSize.fromJson(json[r'batch_size']),
