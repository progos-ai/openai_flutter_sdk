...
class ModifyAssistantRequest {
  ...
  @override
  String toString() => 'ModifyAssistantRequest[model=$model, reasoningEffort=$reasoningEffort, name=$name, description=$description, instructions=$instructions, tools=$tools, toolResources=$toolResources, metadata=$metadata, temperature=$temperature, topP=$topP, responseFormat=$responseFormat]';
  ...
  static ModifyAssistantRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ModifyAssistantRequest(
        model: ModifyAssistantRequestModel.fromJson(json[r'model']),
        ...
        toolResources: ModifyAssistantRequestToolResources.fromJson(json[r'tool_resources']),
