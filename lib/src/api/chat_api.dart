...
class ChatApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateChatCompletionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateChatCompletionResponse>> createChatCompletion({ 
    required CreateChatCompletionRequest createChatCompletionRequest,
    ...
    final _path = r'/chat/completions';
    ...
    try {
      const _type = FullType(CreateChatCompletionRequest);
      _bodyData = _serializers.serialize(createChatCompletionRequest, specifiedType: _type);
    ...
    CreateChatCompletionResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateChatCompletionResponse),
    ...
    return Response<CreateChatCompletionResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChatCompletionDeleted] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatCompletionDeleted>> deleteChatCompletion({ 
    ...
    final _path = r'/chat/completions/{completion_id}'.replaceAll('{' r'completion_id' '}', encodeQueryParameter(_serializers, completionId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ChatCompletionDeleted? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ChatCompletionDeleted),
      ) as ChatCompletionDeleted;
    ...
    return Response<ChatCompletionDeleted>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [CreateChatCompletionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateChatCompletionResponse>> getChatCompletion({ 
    required String completionId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChatCompletionMessageList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatCompletionMessageList>> getChatCompletionMessages({ 
    required String completionId,
    String? after,
    int? limit = 20,
    String? order = 'asc',
    ...
    final _path = r'/chat/completions/{completion_id}/messages'.replaceAll('{' r'completion_id' '}', encodeQueryParameter(_serializers, completionId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ChatCompletionMessageList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ChatCompletionMessageList),
    ...
    return Response<ChatCompletionMessageList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ChatCompletionList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ChatCompletionList>> listChatCompletions({ 
    String? model,
    ...
    ChatCompletionList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ChatCompletionList),
      ) as ChatCompletionList;
    ...
    return Response<ChatCompletionList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [CreateChatCompletionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateChatCompletionResponse>> updateChatCompletion({ 
    required String completionId,
    required UpdateChatCompletionRequest updateChatCompletionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateChatCompletionRequest);
      _bodyData = _serializers.serialize(updateChatCompletionRequest, specifiedType: _type);
