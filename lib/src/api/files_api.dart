...
class FilesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OpenAIFile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OpenAIFile>> createFile({ 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DeleteFileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeleteFileResponse>> deleteFile({ 
    ...
    final _path = r'/files/{file_id}'.replaceAll('{' r'file_id' '}', encodeQueryParameter(_serializers, fileId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
    ...
    DeleteFileResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DeleteFileResponse),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> downloadFile({ 
    required String fileId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/files/{file_id}/content'.replaceAll('{' r'file_id' '}', encodeQueryParameter(_serializers, fileId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListFilesResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListFilesResponse>> listFiles({ 
    String? purpose,
    int? limit = 10000,
    String? order = 'desc',
    String? after,
    ...
    ListFilesResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListFilesResponse),
  ...
  /// Returns a [Future] containing a [Response] with a [OpenAIFile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OpenAIFile>> retrieveFile({ 
    required String fileId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
