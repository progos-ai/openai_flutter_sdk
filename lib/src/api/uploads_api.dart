...
class UploadsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [UploadPart] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UploadPart>> addUploadPart({ 
    ...
    final _path = r'/uploads/{upload_id}/parts'.replaceAll('{' r'upload_id' '}', encodeQueryParameter(_serializers, uploadId, const FullType(String)).toString());
    ...
    UploadPart? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UploadPart),
      ) as UploadPart;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Upload>> cancelUpload({ 
    required String uploadId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/uploads/{upload_id}/cancel'.replaceAll('{' r'upload_id' '}', encodeQueryParameter(_serializers, uploadId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Upload>> completeUpload({ 
    required String uploadId,
    required CompleteUploadRequest completeUploadRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/uploads/{upload_id}/complete'.replaceAll('{' r'upload_id' '}', encodeQueryParameter(_serializers, uploadId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CompleteUploadRequest);
      _bodyData = _serializers.serialize(completeUploadRequest, specifiedType: _type);
  ...
  Future<Response<Upload>> createUpload({ 
    ...
    try {
      const _type = FullType(CreateUploadRequest);
      _bodyData = _serializers.serialize(createUploadRequest, specifiedType: _type);
