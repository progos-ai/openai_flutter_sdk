...
class UsersApi {
  ...
  Future<Response<UserDeleteResponse>> deleteUser({ 
    ...
    final _path = r'/organization/users/{user_id}'.replaceAll('{' r'user_id' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserDeleteResponse),
    ...
    return Response<UserDeleteResponse>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserListResponse>> listUsers({ 
    int? limit = 20,
    String? after,
    ...
    final _path = r'/organization/users';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (emails != null) r'emails': encodeCollectionQueryParameter<String>(_serializers, emails, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> modifyUser({ 
    required String userId,
    required UserRoleUpdateRequest userRoleUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UserRoleUpdateRequest);
      _bodyData = _serializers.serialize(userRoleUpdateRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [User] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> retrieveUser({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
