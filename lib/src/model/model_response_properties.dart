...
part 'model_response_properties.g.dart';
...
abstract class ModelResponseProperties  {
  ...
  static Serializer<ModelResponseProperties> get serializer => _$ModelResponsePropertiesSerializer();
}

class _$ModelResponsePropertiesSerializer implements PrimitiveSerializer<ModelResponseProperties> {
  @override
  final Iterable<Type> types = const [ModelResponseProperties];

  @override
  final String wireName = r'ModelResponseProperties';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ModelResponseProperties object, {
  ...
  @override
  ModelResponseProperties deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    return serializers.deserialize(serialized, specifiedType: FullType($ModelResponseProperties)) as $ModelResponseProperties;
  }
}

/// a concrete implementation of [ModelResponseProperties], since [ModelResponseProperties] is not instantiable
@BuiltValue(instantiable: true)
abstract class $ModelResponseProperties implements ModelResponseProperties, Built<$ModelResponseProperties, $ModelResponsePropertiesBuilder> {
  $ModelResponseProperties._();

  factory $ModelResponseProperties([void Function($ModelResponsePropertiesBuilder)? updates]) = _$$ModelResponseProperties;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults($ModelResponsePropertiesBuilder b) => b;
...
class _$$ModelResponsePropertiesSerializer implements PrimitiveSerializer<$ModelResponseProperties> {
  @override
  final Iterable<Type> types = const [$ModelResponseProperties, _$$ModelResponseProperties];
  ...
  Object serialize(
    ...
    return serializers.serialize(object, specifiedType: FullType(ModelResponseProperties))!;
  }
  ...
  void _deserializeProperties(
    ...
    required ModelResponsePropertiesBuilder result,
  ...
  $ModelResponseProperties deserialize(
    ...
    final result = $ModelResponsePropertiesBuilder();
