...
void main() {
  // final instance = ChatCompletionMessageListDataInner();

  group('test ChatCompletionMessageListDataInner', () {
    ...
    // List<ChatCompletionResponseMessageAnnotationsInner> annotations (default value: const [])
