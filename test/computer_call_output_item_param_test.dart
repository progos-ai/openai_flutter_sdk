...
void main() {
  // final instance = ComputerCallOutputItemParam();

  group('test ComputerCallOutputItemParam', () {
    ...
    // List<ComputerCallSafetyCheckParam> acknowledgedSafetyChecks (default value: const [])
