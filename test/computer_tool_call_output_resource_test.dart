...
// tests for ComputerToolCallOutputResource
void main() {
  final instance = ComputerToolCallOutputResourceBuilder();
  // TODO add properties to the builder and call build()

  group(ComputerToolCallOutputResource, () {
    ...
    // BuiltList<ComputerToolCallSafetyCheck> acknowledgedSafetyChecks
