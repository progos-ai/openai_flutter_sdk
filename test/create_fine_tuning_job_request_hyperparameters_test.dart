...
// tests for CreateFineTuningJobRequestHyperparameters
void main() {
  // final instance = CreateFineTuningJobRequestHyperparameters();

  group('test CreateFineTuningJobRequestHyperparameters', () {
