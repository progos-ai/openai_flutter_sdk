...
// tests for CreateTranscriptionRequestChunkingStrategy
void main() {
  final instance = CreateTranscriptionRequestChunkingStrategyBuilder();
  // TODO add properties to the builder and call build()

  group(CreateTranscriptionRequestChunkingStrategy, () {
