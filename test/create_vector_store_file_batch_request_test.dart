...
void main() {
  // final instance = CreateVectorStoreFileBatchRequest();

  group('test CreateVectorStoreFileBatchRequest', () {
    ...
    // Map<String, VectorStoreFileAttributesValue> attributes (default value: const {})
