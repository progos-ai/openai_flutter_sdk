...
// tests for FineTuneChatCompletionRequestAssistantMessage
void main() {
  final instance = FineTuneChatCompletionRequestAssistantMessageBuilder();
  // TODO add properties to the builder and call build()

  group(FineTuneChatCompletionRequestAssistantMessage, () {
