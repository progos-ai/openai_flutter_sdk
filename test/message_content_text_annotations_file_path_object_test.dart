...
// tests for MessageContentTextAnnotationsFilePathObject
void main() {
  final instance = MessageContentTextAnnotationsFilePathObjectBuilder();
  // TODO add properties to the builder and call build()

  group(MessageContentTextAnnotationsFilePathObject, () {
    // Always `file_path`.
    // String type
