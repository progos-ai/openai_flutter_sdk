...
// tests for MessageDeltaContentTextObjectTextAnnotationsInner
void main() {
  final instance = MessageDeltaContentTextObjectTextAnnotationsInnerBuilder();
  // TODO add properties to the builder and call build()

  group(MessageDeltaContentTextObjectTextAnnotationsInner, () {
