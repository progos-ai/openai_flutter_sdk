...
void main() {
  // final instance = RealtimeServerEventConversationItemInputAudioTranscriptionFailed();

  group('test RealtimeServerEventConversationItemInputAudioTranscriptionFailed', () {
