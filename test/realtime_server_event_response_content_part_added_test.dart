...
// tests for RealtimeServerEventResponseContentPartAdded
void main() {
  final instance = RealtimeServerEventResponseContentPartAddedBuilder();
  // TODO add properties to the builder and call build()

  group(RealtimeServerEventResponseContentPartAdded, () {
