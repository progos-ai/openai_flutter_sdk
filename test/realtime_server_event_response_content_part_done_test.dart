...
// tests for RealtimeServerEventResponseContentPartDone
void main() {
  final instance = RealtimeServerEventResponseContentPartDoneBuilder();
  // TODO add properties to the builder and call build()

  group(RealtimeServerEventResponseContentPartDone, () {
