...
// tests for RealtimeSessionCreateRequestInputAudioTranscription
void main() {
  final instance = RealtimeSessionCreateRequestInputAudioTranscriptionBuilder();
  // TODO add properties to the builder and call build()

  group(RealtimeSessionCreateRequestInputAudioTranscription, () {
