...
void main() {
  // final instance = RealtimeTranscriptionSessionCreateRequestInputAudioTranscription();

  group('test RealtimeTranscriptionSessionCreateRequestInputAudioTranscription', () {
