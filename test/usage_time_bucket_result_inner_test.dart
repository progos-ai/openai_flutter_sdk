...
// tests for UsageTimeBucketResultInner
void main() {
  final instance = UsageTimeBucketResultInnerBuilder();
  // TODO add properties to the builder and call build()

  group(UsageTimeBucketResultInner, () {
    // String object
    ...
    // int numSessions
    test('to test the property `numSessions`', () async {
      // TODO
    });
    ...
    // String lineItem
    test('to test the property `lineItem`', () async {
      // TODO
    });
