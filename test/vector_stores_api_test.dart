...
void main() {
  // final instance = VectorStoresApi();

  group('tests for VectorStoresApi', () {
    ...
    test('test retrieveVectorStoreFileContent', () async {
      // TODO
    });
    ...
    test('test searchVectorStore', () async {
      // TODO
    });
    ...
    test('test updateVectorStoreFileAttributes', () async {
      // TODO
    });
